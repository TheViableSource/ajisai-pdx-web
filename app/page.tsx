    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif text-white mb-8 tracking-tight leading-tight">
            The Art of <br />
            <span className="italic text-ajisai-gold">Japanese Dining</span>
          </h1>
      ...
      <section className="w-full bg-ajisai-cream py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-ajisai-wine text-4xl md:text-5xl font-serif mb-4">Our Culinary Craft</h2>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 mb-24">
            <div className="md:w-1/2 text-center md:text-left space-y-6">
              ...
              <Link href="/menus#sushi" className="inline-flex items-center text-ajisai-wine hover:text-ajisai-gold transition-colors uppercase tracking-widest text-sm font-semibold mt-4">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-12 mb-24">
            <div className="md:w-1/2 text-center md:text-left space-y-6">
              ...
              <Link href="/menus#ramen" className="inline-flex items-center text-ajisai-wine hover:text-ajisai-gold transition-colors uppercase tracking-widest text-sm font-semibold mt-4">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 text-center md:text-left space-y-6">
              ...
              <Link href="/menus#steak" className="inline-flex items-center text-ajisai-wine hover:text-ajisai-gold transition-colors uppercase tracking-widest text-sm font-semibold mt-4">
      ...
      <section className="relative w-full h-[60vh] flex items-center justify-center bg-fixed bg-center bg-cover" 
        ...
        <div className="relative z-10 text-center max-w-2xl px-6">
           ...
           <Link href="/about" className="text-white border-b border-ajisai-gold pb-1 hover:text-ajisai-gold transition-colors">
             Read Our Story
           </Link>
        </div>
      </section>
